...
#'
#' If checksum provided, will check that file checksum is the same and crash if not. If no checksum provided, stores the checksum of
#' the file in the pipeline log.
#'
...
#'
#' @export
mt_other_checksum <- function(D, file, checksum) {
