...
#'
#' Does not change anything in the actual dataset, but just the factor order of a column in colData. Can be used to change the plotting
...
#'
#' @examples
#' \dontrun{%>% mt_anno_reorder_sample("Group", c('WT_Norm_F','WT_Hyp_F','KO_Norm_F','KO_Hyp_F','WT:KO2_F','WT:WT2_F')) %>%}
#'
#' @author JK
#'
#' @export
mt_anno_reorder_sample <- function(D, col_name, new_order) {
